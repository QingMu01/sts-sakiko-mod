...
public class ChoosePurple extends AbstractSakikoCard {
    ...
    public ChoosePurple(AbstractMusic sourceCard, int amount) {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new DiscoveryCharCardAction(this.sourceCard, CardColor.PURPLE, Math.max(this.baseMagicNumber, this.magicNumber)));
    }
