...
import com.qingmu.sakiko.powers.YowaiwatashiPower;
import com.qingmu.sakiko.utils.ModNameHelper;

import static com.qingmu.sakiko.patch.SakikoEnum.CharacterEnum.QINGMU_SAKIKO_CARD;

public class Yowaiwatashi extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new YowaiwatashiPower(p, this.magicNumber < 0 ? this.baseMagicNumber : this.magicNumber)));
