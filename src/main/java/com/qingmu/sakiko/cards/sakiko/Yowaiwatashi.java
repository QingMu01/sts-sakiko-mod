...
public class Yowaiwatashi extends AbstractSakikoCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new CardSelectorAction("", this.magicNumber, true, card -> CardGroup.CardGroupType.EXHAUST_PILE, cardList -> {
            this.addToBot(new MakeTempCardInHandAction(new Remember(), cardList.size()));
