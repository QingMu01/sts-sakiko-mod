...
public class MakeKingOfTingEX extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new KingOfTingPower(p, Math.max(this.magicNumber, this.baseMagicNumber))));
    }
}
