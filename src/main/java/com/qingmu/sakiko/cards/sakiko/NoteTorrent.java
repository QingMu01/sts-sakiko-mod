...
import com.qingmu.sakiko.action.NoteTorrentAction;
...
public class NoteTorrent extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new NoteTorrentAction(p, this.multiDamage, this.damageTypeForTurn, this.freeToPlayOnce, this.energyOnUse));
    }
}
