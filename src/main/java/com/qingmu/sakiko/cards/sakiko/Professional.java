...
import com.qingmu.sakiko.action.ProfessionalAction;
...
public class Professional extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ProfessionalAction(p, (this.magicNumber < 0 ? this.baseMagicNumber : this.magicNumber) + this.block));
    }
}
