...
public class CardRemoveReward extends CustomReward {

    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(ModNameHelper.make(CardRemoveReward.class.getSimpleName()));
    private static final String[] TEXT = uiStrings.TEXT;

    private static final RewardType TYPE = SakikoEnum.RewardType.CARD_REMOVE;

    private static final String ICON = "SakikoModResources/img/ui/cardRemovedReward.png";

    public CardRemoveReward() {
    ...
    public boolean claimReward() {
        if (AbstractDungeon.screen == AbstractDungeon.CurrentScreen.COMBAT_REWARD) {
            ...
            for (AbstractCard card : CardsHelper.md().group) {
                if (CardsHelper.notInBottle(card) && CardsHelper.canBeRemoved(card)) {
                    cards.add(card);
                }
            }
