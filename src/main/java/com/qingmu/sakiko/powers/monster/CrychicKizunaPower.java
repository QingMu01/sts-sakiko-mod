...
public class CrychicKizunaPower extends AbstractSakikoPower {
    ...
    public int onAttackedToChangeDamage(DamageInfo info, int damageAmount) {
        if (AbstractDungeon.actionManager.currentAction instanceof DamageAllEnemiesAction || info.type != DamageInfo.DamageType.NORMAL || this.owner.isPlayer || damageAmount <= 0){
            return damageAmount;
        } else {
