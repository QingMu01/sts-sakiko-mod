...
public class OverdrawPower extends TwoAmountPower {
    ...
    public OverdrawPower(AbstractCreature owner, int amount, int tired) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void atStartOfTurn() {
        ...
        this.addToBot(new ApplyPowerAction(this.owner, this.owner, new OverworkPower(this.owner, this.amount2)));
