...
public class BlockedPower extends AbstractSakikoPower {

    public static final String POWER_ID = ModNameHelper.make(BlockedPower.class.getSimpleName());
    ...
    public BlockedPower(AbstractCreature owner, int amount) {
